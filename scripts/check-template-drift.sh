...
# (bilingual EN+JA docs) and claudeSkills (the three .claude/skills/zudo-doc-*
# skills), and neither tauri nor tauriDev. Adding an unscaffolded feature
# would produce spurious [MISSING IN PROD] errors.
for feature in i18n claudeSkills; do
